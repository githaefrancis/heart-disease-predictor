...
cigsPerDay = col2.number_input("Number of daily cigarettes")
...
dia_bp = col3.number_input("Enter the diastolic blood pressure")
bmi = col1.number_input("Enter your BM1")
...
df_pred["prevalentHyp"] = df_pred["prevalentHyp"].apply(
    lambda x: 1 if x == "Yes" else 0
)
df_pred["prevalentStroke"] = df_pred["prevalentStroke"].apply(
    lambda x: 1 if x == "Yes" else 0
)
...
df_pred["currentSmoker"] = df_pred["currentSmoker"].apply(
    lambda x: 1 if x == "Yes" else 0
)
